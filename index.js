...
const eurNokRate = Number(process.env.EUR_NOK_RATE) || 9.87; // TODO: Use an currency exchange API to get rate
const btcAmount =  Number(process.env.BTC_AMOUNT) || 0.003; // TODO: Use GDAX API to get exact amount
